...
const Navbar = () => {
  ...
  const getLinks = () => {
    ...
    const userLinks = [{ to: "/reports", label: "Reports" }, { to: "/query", label: "AI Query" }];
    
    if (profile?.role === "teacher") {
      return [
        ...baseLinks,
        { to: "/teacher/create-meeting", label: "Create Meeting" },
        { to: "/teacher/manage-meetings", label: "Manage Meetings" },
        ...userLinks
      ];
    }
    ...
    if (profile?.role === "student") {
      return [
        ...baseLinks,
        { to: "/student/join-meeting", label: "Join Meeting" },
        ...userLinks
      ];
    }
